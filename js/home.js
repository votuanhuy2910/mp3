...
const app = {
    songsData : [
        {
            background: './assets/files/component/img/songs/0.webp',
            name: 'Anh Đã Lạc Vào',
            singer: 'Green, Đại Mèo Remix',
            pathSong: './assets/files/component/music/list-song/0.mp3',
            duration : '04:27',
        },
        {
            background: './assets/files/component/img/songs/1.webp',
            name: 'Chạy Về Khóc Với Anh',
            singer: 'Erik, Duzme Remix',
            pathSong: './assets/files/component/music/list-song/1.mp3',
            duration : '04:05',
        },
        {
            background: './assets/files/component/img/songs/2.jpeg',
            name: 'Sẵn Sàng Yêu Em Đi Thôi',
            singer: 'Woni, Minh Tú, Đại Mèo Remix',
            pathSong: './assets/files/component/music/list-song/2.mp3',
            duration : '03:51',
        },
        {
            background: './assets/files/component/img/songs/3.webp',
            name: 'Gieo Quẻ',
            singer: 'Hoàng Thuỳ Linh, ĐEN, Orinn Remix',
            pathSong: './assets/files/component/music/list-song/3.mp3',
            duration : '04:27',
        },
        {
            background: './assets/files/component/img/songs/4.webp',
            name: 'Vui Lắm Nha',
            singer: 'Hương Ly, Jombie, RIN Music Remix',
            pathSong: './assets/files/component/music/list-song/4.m4a',
            duration : '05:16',
        },
        {
            background: './assets/files/component/img/songs/5.webp',
            name: 'Lưu Số Em Đi',
            singer: 'Huỳnh Văn, V.P. Tiên, Đại Mèo Remix',
            pathSong: './assets/files/component/music/list-song/5.m4a',
            duration : '04:10',
        },
        {
            background: './assets/files/component/img/songs/6.webp',
            name: 'Như Một Người Dưng',
            singer: 'Nguyễn Thạc Bảo Ngọc, Remix',
            pathSong: './assets/files/component/music/list-song/6.mp3',
            duration : '05:05',
        },
        {
            background: './assets/files/component/img/songs/7.webp',
            name: 'Ôm Nhiều Mộng Mơ',
            singer: 'Phát Huy T4, Đại Mèo Remix',
            pathSong: './assets/files/component/music/list-song/7.m4a',
            duration : '03:16',
        },
        {
            background: './assets/files/component/img/songs/8.jpg',
            name: 'Tình Yêu Ngủ Quên',
            singer: 'Hoàng Tôn, LyHan, Orinn Remix',
            pathSong: './assets/files/component/music/list-song/8.mp3',
            duration : '04:27',
        },
        {
            background: './assets/files/component/img/songs/9.webp',
            name: 'Không Bằng',
            singer: 'Na, RIN Music Remix',
            pathSong: './assets/files/component/music/list-song/9.m4a',
            duration : '03:23',
        },
        {
            background: './assets/files/component/img/songs/10.webp',
            name: 'Ai Chung Tình Được Mãi',
            singer: 'Đinh Tùng Huy, ACV Remix',
            pathSong: './assets/files/component/music/list-song/10.m4a',
            duration : '03:55',
        },
        {
            background: './assets/files/component/img/songs/11.webp',
            name: 'Cô Đơn Dành Cho Ai',
            singer: 'NAL, LEE KEN, Orinn Remix',
            pathSong: './assets/files/component/music/list-song/11.m4a',
            duration : '04:45',
        },
        {
            background: './assets/files/component/img/songs/12.webp',
            name: 'Ánh mắt ta chạm nhau',
            singer: 'Ngô Lan Hương, Đại Mèo remix',
            pathSong: './assets/files/component/music/list-song/12.m4a',
            duration : '06:01',
        },
        {
            background: './assets/files/component/img/songs/13.webp',
            name: '2 Phút Hơn',
            singer: 'Phao, KAIZ Remix',
            pathSong: './assets/files/component/music/list-song/13.m4a',
            duration : '05:02',
        },
        {
            background: './assets/files/component/img/songs/14.webp',
            name: 'Là Ai Từ Bỏ Là Ai Vô Tình',
            singer: 'Hương Ly, Jombie (G5R), RIN Music Remix',
            pathSong: './assets/files/component/music/list-song/14.m4a',
            duration : '03:25',
        },
        {
            background: './assets/files/component/img/songs/2.jpeg',
            ...
            pathSong: './assets/files/component/music/list-song/15.m4a',
            duration : '03:51',
        },
    ],
    currentIndex : 0,
        ...
        themeItems.forEach((themeItem, index) => {
            themeItem.onclick = function() {
                if (index == 0) {
                    ...
                    $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/files/component/img/background-theme/backroundThemes/0.svg)';
                    ...
                    $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/files/component/img/background-theme/backroundThemes/1.jpg)';
                    ...
                    $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/files/component/img/background-theme/backroundThemes/2.jpg)';
                    $('.main-music-control').style.backgroundImage = 'none';
                    ...
                    $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/files/component/img/background-theme/backroundThemes/3.jpg)';
                    $('.main-music-control').style.backgroundImage = 'none';
                    ...
                    $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/files/component/img/background-theme/backroundThemes/4.jpg)';
                    $('.main-music-control').style.backgroundImage = 'none';
                    ...
                    $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/files/component/img/background-theme/backroundThemes/5.jpg)';
                    $('.main-music-control').style.backgroundImage = 'none';
                    ...
                    $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/files/component/img/background-theme/backroundThemes/6.jpg)';
                    $('.main-music-control').style.backgroundImage = 'none';
                    ...
                    $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/files/component/img/background-theme/backroundThemes/7.jpg)';
                    $('.main-music-control').style.backgroundImage = 'none';
                    ...
                    <div class="songs-item-left">
                        <div style="background-image: url(${song.background});" class="songs-item-left-img js__songs-item-left-img-0">
                            ...
                            <div class="songs-item-left-img-playing-box">
                                <img class = "songs-item-left-img-playing" src="./assets/files/component/img/songs/icon-playing.gif" alt="playing">
                            </div>
                        </div>
